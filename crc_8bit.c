...
#define IMP_TABLE  1
#define IMP_NIBBLES  2
#define IMP_BITS  3

#ifndef CRC8_IMPLEMENTATION
 #define CRC8_IMPLEMENTATION  IMP_BITS
#endif


#if CRC8_IMPLEMENTATION == IMP_TABLE
...
#if CRC8_IMPLEMENTATION == IMP_NIBBLES
...
#if CRC8_IMPLEMENTATION == IMP_BITS
unsigned char crc8(unsigned char data)
{
	unsigned char i = (data ^ crc);
